...
--
-- Name: bulk_tree_upload; Type: TABLE; Schema: public; Owner: adeebatak
--
...
ALTER TABLE public.bulk_tree_upload OWNER TO adeebatak;

--
-- Name: bulk_tree_upload_id_seq; Type: SEQUENCE; Schema: public; Owner: adeebatak
--
...
ALTER TABLE public.bulk_tree_upload_id_seq OWNER TO adeebatak;

--
-- Name: bulk_tree_upload_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: adeebatak
--
...
--
-- Name: bulk_tree_upload id; Type: DEFAULT; Schema: public; Owner: adeebatak
--
...
--
-- Name: bulk_tree_upload bulk_tree_upload_pkey; Type: CONSTRAINT; Schema: public; Owner: adeebatak
--
